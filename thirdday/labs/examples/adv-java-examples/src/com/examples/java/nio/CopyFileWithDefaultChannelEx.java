...
public class CopyFileWithDefaultChannelEx {
	...
	{
		// create a path for file named input.txt from current folder
		Path filePath = FileSystems.getDefault().getPath("./input/input.txt");
		...
		Path fileCopy = FileSystems.getDefault().getPath("./output/output.txt");
